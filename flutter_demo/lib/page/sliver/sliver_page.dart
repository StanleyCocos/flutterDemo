...
class SliverPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _SliverState();
}

class _SliverState extends State<SliverPage>
  ...
  TabBar initTabBar() {
    return TabBar(
      ...
      onTap: (index){
        _pageController.animateToPage(index, duration: Duration(microseconds: 2000), curve: Curves.easeOut);
      },
  ...
  Widget _initTabBarView() {
    return PageView(
      ...
      onPageChanged: (index){
        _tabController.animateTo(index, duration: Duration(microseconds: 2000), curve: Curves.easeOut);
      },
      children: [
        initListView("数学"),
        initListView("英语"),
